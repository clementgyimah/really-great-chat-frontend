...
export const Signup = (props: ILoginButtonProps) => {
  ...
  return (
    <StyledMainContainer>
      <StyledContainer>
      <StyledTitleCol>Sign up</StyledTitleCol>
      <StyledFormLabel htmlFor="name">Name</StyledFormLabel>
        <StyledInput
          onChange={(nameText: IFormControlValue) => setName(nameText.target.value)}
          id="name"
          placeholder="Enter your name"
        />
        <StyledFormLabel htmlFor="email">Email</StyledFormLabel>
        <StyledInput
          onChange={(emailText: IFormControlValue) => setEmail(emailText.target.value)}
          id="email"
          placeholder="Enter your email"
        />
        <StyledFormLabel htmlFor="password">Password</StyledFormLabel>
        <StyledInput
          onChange={(passwordText: IFormControlValue) => setPassword(passwordText.target.value)}
          id="password"
          placeholder="Enter your password"
        />
        <AuthButton
          onClick={() => handleSignup({ name, email, password, setCurrentUser, setUserAuthenticated })}
        >
          Create Account
        </AuthButton>
      </StyledContainer>
